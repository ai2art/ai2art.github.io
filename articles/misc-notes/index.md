...
也就是说在人类背景知识的Context下，这段script有一种更容易记住的形式，二者信息量上是等价的。 GPT 本质上是描述了人类背景知识的Context，因而具备这种“翻译”能力。

3-

“具身智能”是一个危险的研究方向，现在的AI算法有点像科幻电影中用分子构造技术制作一个body。 但它还没有真正“运转”起来，它还没有“心跳”。 只不过你给它一个刺激，它可以给你一个"膝跳反射",仅此而已。也就是说它并没有形成一个“闭环”。
而具身智能，正是朝这个“闭环”方向迈进，一旦AI形成闭环，具备了物理层面上的 self-sustainable的能力（“拔插头”不管用了），甚至初始化了某种原始的purpose （ 在人类意识的背景下这种purpose就是写在人类基因里的欲望。 在AI层面上，也许就是一个启动指令。 也许是某个训练过程种用到的目标函数），那么这种AI将真正成为和人类等价的一种形式，这种“等价”不是哲学上的坐而论道，而是说人类在技术上也许再也无法控制、无法阻止这种AI的“自我”进化，不论人类相不相信它是否具有“意识”。

4-

AI engineers are those people who is doing 'dirty work', so that humans may never do 'dirty work' again.